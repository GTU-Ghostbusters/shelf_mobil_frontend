          ...
          switch (snapshot.connectionState) {
            ...
            default:
              if (snapshot.hasError) {
                ...
                _bookList = booksFromJson(snapshot.data!.body);
                ...
                : Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (BuildContext context) {
                        return BookDetailPage(book: _bookList[index]);
                      },
                    ),
                  );
          },
